...
<div style="margin-top: 14px;">
    ...
    <table cellspacing="4" cellpadding="0" border="0" class="Normal">
        ...
        <!-- settings for js crutch for image filter -->
        <tr>
            <td><dnn:Label class="Normal" id="lbl_JsCrutchBackgroundImgFolder_s" runat="server" Text="Background image folder" /></td>
            <td><asp:DropDownList runat="server" ID="ddl_JsCrutchBackgroundImgFolder_s" /></td>
        </tr>
        <tr>
            <td><dnn:Label class="Normal" id="lbl_JsCrutchMinWidth_s" runat="server" Text="Min. image width" /></td>
            <td><asp:TextBox runat="server" ID="txt_JsCrutchMinWidth_s" type="number" /></td>
        </tr>
        <tr>
            <td><dnn:Label class="Normal" id="lbl_JsCrutchMinHeight_s" runat="server" Text="Min. image height" /></td>
            <td><asp:TextBox runat="server" ID="txt_JsCrutchMinHeight_s" type="number" /></td>
        </tr>
        <tr>
            <td><dnn:Label class="Normal" id="lbl_JsCrutchMaxWidth_s" runat="server" Text="Max. image width" /></td>
            <td><asp:TextBox runat="server" ID="txt_JsCrutchMaxWidth_s" type="number" /></td>
        </tr>
        <tr>
            <td><dnn:Label class="Normal" id="lbl_JsCrutchMaxHeight_s" runat="server" Text="Max. image height" /></td>
            <td><asp:TextBox runat="server" ID="txt_JsCrutchMaxHeight_s" type="number" /></td>
        </tr>
