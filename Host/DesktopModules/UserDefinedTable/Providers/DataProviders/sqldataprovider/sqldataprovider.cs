...
// ReSharper restore CheckNamespace
{
    ...
    public class SqlDataProvider : DataProvider
    {
        ...
        private void UpdateActiveHRsInDropdownlist(int HrFieldId)
        {
            SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner + ObjectQualifier + "SP_" + SPPrefix + "UpdateActiveHRsInDropdownlist",
                                      HrDbData.ListOfHrsModuleId,
                                      HrDbData.NameFieldId,
                                      HrDbData.ActiveFieldId,
                                      HrFieldId);
        }
        ...
        public void UpdateActiveHRsInVacancies()
        {
            UpdateActiveHRsInDropdownlist(VacanciesDbData.HrFieldId);
        }

        public void UpdateActiveHRsInCamps()
        {
            UpdateActiveHRsInDropdownlist(CampsDbData.HrFieldId);
        }

        public string GetFolderPath(int folderId)
        {
            SqlDataReader reader = SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner + ObjectQualifier + "SP_" + SPPrefix + "GetFolderPath",
                                      folderId);
            DataTable dataTable = Globals.ConvertDataReaderToDataTable(reader);
            ...
            return dataRow["FolderPath"].GetValue<string>();
        }
