...
namespace DotNetNuke.Modules.UserDefinedTable.Components
{
 ...
 //       public const string UseButtons = "UDT_UseButtons";
     ...
     //   public const string TableFreeEditForm = "UDT_TableFreeEditForm";
        ...
        public const string JsCrutchBackgroundImgFolderId = "JsCrutchBackgroundImgFolderId";
        public const string JsCrutchMinWidth = "JsCrutchMinWidth";
        public const string JsCrutchMinHeight = "JsCrutchMinHeight";
        public const string JsCrutchMaxWidth = "JsCrutchMaxWidth";
        public const string JsCrutchMaxHeight = "JsCrutchMaxHeight";
    }
}