...
namespace DotNetNuke.Modules.UserDefinedTable.DataTypes
{
    ...
    {
        /*
        // Code, that was initially intended to be used for js crutch for image filter.
        // See also comment, that contains "<!-- js crutch for image filter -->" in Form.ascx code.
        //public DataTypeImage()
        //{
        //    CreateNecessaryFolders();
        //}

        //protected void CreateNecessaryFolders()
        //{
        //    List<string> foldersForImages = new List<string>()
        //    {
        //        "VacancyBackgroundImage"
        //    };

        //    foreach (string folderName in foldersForImages)
        //    {
        //        string folderFullPath = Path.Combine(Globals.ApplicationMapPath, Globals.GetPortalSettings().HomeDirectory.TrimStart('/'), folderName);
